...
from nico_data import get_dg_dataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logdir', type=str, default='./tensorboard/res18_poer/NICO/res18_224_run0')
    parser.add_argument('--save_path', type=str, default='./saved_models/res18_poer/NICO/res18_224_run0')
